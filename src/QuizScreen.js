...
//   useEffect(() => {
//     setShuffledQuestions(shuffleOptions(currentQuestions));
//     showRulesAlert();
//   }, []);
...
//   useEffect(() => {
//     // Automatically move to the next question when the timer elapses
//     if (timer === 0 && !answered) {
//       handleNext();
//     }
//   }, [timer, answered]);
...
//     return () => clearInterval(timerInterval); // Clear the timer interval when unmounting
//   }, []);
...
//           <View style={{ ...styles.content, margin: 20, paddingBottom: 20 }}>
//             <View style={styles.questionContainer}>
//               <Text style={{ ...styles.questionText, color: '#FFFCFF' }}>{shuffledQuestions[currentQuestion]?.question}</Text>
//               <Text style={styles.questionCount}>{`Question ${currentQuestion + 1} of ${questionCount}`}</Text>
//             </View>
//             <View style={styles.optionsContainer}>
...
//                   style={[
//                     styles.optionButton,
//                     selectedOption === option && option === shuffledQuestions[currentQuestion]?.correctAnswer
//                       ? styles.correctOption
//                       : selectedOption === option && option !== shuffledQuestions[currentQuestion]?.correctAnswer
//                       ? styles.wrongOption
//                       : null,
...
//             </View>
//             <TouchableOpacity style={styles.nextButton} onPress={handleNext} disabled={!answered}>
//               <Text style={styles.nextButtonText}>{currentQuestion === shuffledQuestions.length - 1 ? 'Finish' : 'Next'}</Text>
//             </TouchableOpacity>
//           </View>
//         </ScrollView>
//       </ImageBackground>
...
//   useEffect(() => {
//     handleStartExam(); // Start the timer when the component mounts
//     showRulesAlert();
//     setShuffledQuestions(shuffleOptions(currentQuestions));
//   }, []);
...
//     return () => {
//       clearInterval(timer); // Clear the timer interval when the component unmounts
//       unsubscribe();
//     };
//   }, []);
